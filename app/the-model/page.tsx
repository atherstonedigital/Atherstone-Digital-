      ...
      <div className="pt-36 pb-20 bg-brand-dark min-h-screen">
        ...
        <section className="relative px-6 mb-20">
          ...
          <div className="container mx-auto max-w-5xl text-center relative z-10">
            <div className="inline-flex items-center gap-2 px-3 py-1 mb-6 border border-brand-primary/30 rounded-full bg-brand-primary/5">
              <span className="text-brand-primary text-xs font-sans uppercase tracking-widest font-bold">Strategy + Automation</span>
            </div>
            ...
            <p className="text-xl text-brand-muted max-w-3xl mx-auto leading-relaxed">
              A hybrid workflow where <span className="text-brand-text font-medium">Human Strategy</span> defines the direction, and <span className="text-brand-text font-medium">AI Agents</span> handle the heavy lifting. This is how I achieve 10x output with 1x headcount.
            </p>
          </div>
        </section>
        ...
        <section className="container mx-auto px-6 mb-24">
          <div className="max-w-5xl mx-auto">
            <h2 className="font-display text-3xl font-bold text-brand-text mb-12 text-center">How It Works in Practice</h2>
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-stretch max-w-5xl mx-auto">
            ...
            <div className="relative group bg-brand-surface/40 border border-brand-border rounded-3xl p-8 lg:p-10 hover:bg-brand-surface/60 transition-colors">
              ...
              <div className="flex items-center gap-6 mb-8">
                ...
                <div>
                  <h2 className="text-3xl font-display font-bold text-brand-text">The Human Role</h2>
                  <p className="text-brand-muted text-sm font-sans uppercase tracking-wide">Direction & Intuition</p>
                </div>
              </div>
              <p className="text-brand-muted text-lg leading-relaxed mb-8">
                AI is powerful, but it cannot replace <strong className="text-brand-text">Commercial Intuition</strong>. My role is to act as your Fractional C-Suite partner — sitting in your leadership meetings, auditing your P&L, and making the high-stakes decisions that algorithms can&apos;t.
              </p>
              <div className="space-y-4">
                {[
                  ...
                  <div key={item.title} className="flex gap-4 p-4 rounded-xl bg-brand-text/[0.03] border border-brand-border">
                    <item.icon className="text-brand-primary mt-1 shrink-0" size={24} />
                    <div>
                      <strong className="text-brand-text block text-lg mb-1">{item.title}</strong>
            ...
            <div className="relative group bg-brand-surface/40 border border-brand-border rounded-3xl p-8 lg:p-10 hover:bg-brand-surface/60 transition-colors">
              ...
              <div className="flex items-center gap-6 mb-8">
                ...
                <div>
                  <h2 className="text-3xl font-display font-bold text-brand-text">The AI Agents</h2>
                  <p className="text-brand-muted text-sm font-sans uppercase tracking-wide">Execution & Scale</p>
                </div>
              </div>
              <p className="text-brand-muted text-lg leading-relaxed mb-8">
                While I set the strategy, my fleet of custom <strong className="text-brand-text">n8n Workflows</strong> and <strong className="text-brand-text">LLM Agents</strong> execute the tactical work 24/7 — eliminating human error and busy work entirely.
              </p>
              <div className="space-y-4">
                {[
        ...
        <section className="container mx-auto px-6 mb-24">
          <div className="max-w-4xl mx-auto bg-brand-surface border border-brand-border rounded-2xl p-10">
            <h2 className="font-display text-2xl font-bold text-brand-text mb-8 text-center">The Tool Stack</h2>
        ...
        <section className="container mx-auto px-6 mb-16">
          <div className="bg-brand-surfaceHighlight rounded-3xl p-12 text-center border border-brand-border relative overflow-hidden group max-w-4xl mx-auto">
            ...
            <div className="relative z-10 max-w-2xl mx-auto">
              <h2 className="text-3xl lg:text-4xl font-display font-bold text-brand-text mb-6">Ready to deploy this system?</h2>
