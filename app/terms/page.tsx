  ...
  return (
    <div className="pt-40 pb-20 bg-brand-dark min-h-screen">
      <div className="container mx-auto px-6 max-w-4xl">
        ...
        <h1 className="font-display text-4xl lg:text-5xl font-bold text-brand-text mb-4">Terms of Service</h1>
        ...
        <div className="space-y-8 text-brand-text/90 leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-bold text-brand-text mb-4">2. Services</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-bold text-brand-text mb-4">6. Contact Information</h2>
            <p>
