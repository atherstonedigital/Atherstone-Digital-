...
export const SERVICES_DATA: ServiceItem[] = [
  ...
  },
  {
    ...
    seoTitle: 'Google & Meta Ads for Shopify | Lower CAC, Higher ROAS',
    seoDescription: 'Performance Google and Meta campaigns for Shopify brands. Lower CAC, higher ROAS. Managed by a certified Shopify ecommerce consultant.',
    pillar: 'grow',
  },
  {
    id: 'automation',
    ...
    seoTitle: 'Shopify Automation | Save 100+ Hours per Month',
    seoDescription: 'Ecommerce automation for Shopify brands. Connect your stack, eliminate manual tasks, and save 100+ hours per month.',
    pillar: 'run',
  },
  {
    id: 'feeds',
    ...
    seoTitle: 'Google Shopping Feeds | Merchant Centre Optimisation',
  ...
  },
  {
    ...
    seoTitle: 'Email & Retention for Shopify | Klaviyo Flows & SMS',
    seoDescription: 'Increase LTV with expert email and SMS marketing. Automated Klaviyo flows that turn one-time Shopify buyers into loyal customers.',
    pillar: 'grow',
  },
  {
    id: 'llm',
    ...
    seoTitle: 'AI Search Optimisation | Get Found by ChatGPT & Gemini',
    seoDescription: 'AI search optimisation for Shopify stores. Get your brand found by Google Gemini, ChatGPT, and Perplexity with structured data and entity SEO.',
    pillar: 'build',
  },
  {
    id: 'catalogue-health',
    ...
    seoTitle: 'Shopify Catalogue Management | Product Data Audit & Fix',
  ...
  },
  {
    ...
    seoTitle: 'Custom Shopify Development | Apps, Checkout & Integrations',
