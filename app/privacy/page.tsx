  ...
  return (
    <div className="pt-40 pb-20 bg-brand-dark min-h-screen">
      <div className="container mx-auto px-6 max-w-4xl">
        <Link href="/" className="mb-8 text-brand-primary hover:text-brand-text transition-colors flex items-center gap-2 font-medium">
          ← Back to Home
        </Link>
        <h1 className="font-display text-4xl lg:text-5xl font-bold text-brand-text mb-4">Privacy Policy</h1>
        ...
        <div className="space-y-8 text-brand-text/90 leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-bold text-brand-text mb-4">2. Data We Collect</h2>
            ...
            <ul className="list-disc pl-5 space-y-2 text-brand-muted">
              <li><strong className="text-brand-text/80">Personal Identity Data:</strong> Name, email address, phone number, company name.</li>
              <li><strong className="text-brand-text/80">Technical Data:</strong> IP address, browser type, operating system, and usage details via cookies.</li>
              <li><strong className="text-brand-text/80">Marketing Data:</strong> Your preferences in receiving marketing from us.</li>
            </ul>
          </section>
          <section>
            <h2 className="text-2xl font-bold text-brand-text mb-4">3. How We Use Your Data</h2>
          ...
          <section>
            <h2 className="text-2xl font-bold text-brand-text mb-4">4. Data Retention</h2>
            <p>
