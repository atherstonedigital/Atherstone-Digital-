      ...
      <div className="pt-36 pb-20 bg-brand-dark min-h-screen">
        ...
        <section className="container mx-auto px-6 mb-20">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="font-display text-5xl lg:text-6xl font-bold text-brand-text mb-6 tracking-tight">{service.title}</h1>
        ...
        <section className="container mx-auto px-6 mb-20">
          <div className="max-w-4xl mx-auto bg-brand-surface rounded-2xl p-10 border border-brand-border">
            <h2 className="font-display text-2xl font-bold text-brand-text mb-8">What&apos;s Included</h2>
