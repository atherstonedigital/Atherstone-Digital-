      ...
      <section id="contact" className="py-24 bg-brand-surface relative overflow-hidden scroll-mt-28">
        <div className="container mx-auto px-6 relative z-10 text-center">
          <div className="max-w-lg mx-auto">
            ...
            <h2 className="font-display text-3xl font-bold text-brand-text mb-4">Thanks, got it.</h2>
    ...
    <section id="contact" className="py-24 bg-brand-surface relative overflow-hidden scroll-mt-28">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-5xl mx-auto bg-brand-dark rounded-3xl overflow-hidden shadow-2xl border border-brand-border flex flex-col md:flex-row">
          ...
          <div className="p-10 md:w-2/5 bg-gradient-to-br from-brand-surfaceHighlight to-brand-dark text-brand-text flex flex-col justify-between relative overflow-hidden">
          ...
          <div className="p-10 md:w-3/5">
            <div className="mb-8 text-center">
              <a
                ...
                className="inline-flex items-center justify-center gap-2 w-full py-4 bg-brand-primary text-white font-bold rounded-xl hover:bg-brand-accent transition-colors"
              >
            ...
            <form name="application" method="POST" data-netlify="true" onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                <div>
                  ...
                  <input id="app-name" type="text" name="name" required placeholder="Dan Smith" className="w-full bg-brand-surface border border-brand-border rounded-lg px-4 py-3 text-brand-text placeholder-brand-muted/50 focus:outline-none focus:ring-2 focus:ring-brand-primary/50 focus:ring-offset-1 focus:ring-offset-brand-surface focus:border-brand-primary/50 transition-colors text-sm" />
                </div>
                <div>
                  <label htmlFor="app-email" className="block text-xs font-medium text-brand-muted mb-2 uppercase tracking-wider">Email</label>
                  <input id="app-email" type="email" name="email" required placeholder="dan@yourstore.com" className="w-full bg-brand-surface border border-brand-border rounded-lg px-4 py-3 text-brand-text placeholder-brand-muted/50 focus:outline-none focus:ring-2 focus:ring-brand-primary/50 focus:ring-offset-1 focus:ring-offset-brand-surface focus:border-brand-primary/50 transition-colors text-sm" />
                </div>
              </div>
              <div>
                ...
                <input id="app-website" type="url" name="website" required placeholder="https://yourstore.com" className="w-full bg-brand-surface border border-brand-border rounded-lg px-4 py-3 text-brand-text placeholder-brand-muted/50 focus:outline-none focus:ring-2 focus:ring-brand-primary/50 focus:ring-offset-1 focus:ring-offset-brand-surface focus:border-brand-primary/50 transition-colors text-sm" />
              </div>
              <div>
                ...
                <textarea id="app-challenge" name="why_switch" required rows={4} placeholder="A few lines is plenty." className="w-full bg-brand-surface border border-brand-border rounded-lg px-4 py-3 text-brand-text placeholder-brand-muted/50 focus:outline-none focus:ring-2 focus:ring-brand-primary/50 focus:ring-offset-1 focus:ring-offset-brand-surface focus:border-brand-primary/50 transition-colors text-sm resize-none" />
              </div>
              <details className="group rounded-lg border border-brand-border bg-brand-surface">
                ...
                <div className="px-4 pb-4 pt-1 space-y-5">
                  <div>
                    ...
                    <select id="app-revenue" name="revenue" className="w-full bg-brand-surface border border-brand-border rounded-lg px-4 py-3 text-brand-text focus:outline-none focus:ring-2 focus:ring-brand-primary/50 focus:ring-offset-1 focus:ring-offset-brand-surface focus:border-brand-primary/50 transition-colors text-sm appearance-none">
                  ...
                  <div>
                    ...
                    <input id="app-stack" type="text" name="stack" placeholder="e.g. Shopify Plus, Klaviyo, Recharge" className="w-full bg-brand-surface border border-brand-border rounded-lg px-4 py-3 text-brand-text placeholder-brand-muted/50 focus:outline-none focus:ring-2 focus:ring-brand-primary/50 focus:ring-offset-1 focus:ring-offset-brand-surface focus:border-brand-primary/50 transition-colors text-sm" />
                  </div>
                </div>
              </details>
              {error && (
              ...
              <button type="submit" disabled={isSubmitting} className="w-full py-4 bg-brand-primary text-white font-bold rounded-xl hover:bg-brand-accent transition-colors flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed">
