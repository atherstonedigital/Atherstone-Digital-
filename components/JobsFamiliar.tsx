    ...
    <section className="py-20 bg-brand-dark border-t border-brand-border">
      <div className="container mx-auto px-6">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-display font-bold text-brand-text mb-10 text-center">{heading}</h2>
          <div className="grid md:grid-cols-2 gap-6">
            {blocks.map((item) => (
              <div key={item.title} className="bg-brand-surface border border-brand-border p-6 rounded-xl hover:border-red-500/30 transition-colors group">
